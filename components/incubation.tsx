...
const incubation = () => {
  return (
    <section id="incubation" className="bg-accent rounded-lg p-8 text-accent-foreground shadow-md mb-36">
            <div className="space-y-4">
              <h2 className="text-3xl font-bold">Incubation</h2>
              <p>
                The Incubation wing of the Entrepreneurship Cell focuses on providing support and resources to students
                who are interested in starting their own ventures. It aims to help students turn their ideas into viable
                businesses.
              </p>
            </div>
